```bash
echo "deb [trusted=yes] https://github.com/eaa3/ros-humble-franka-packages/raw/jammy-humble/ ./" | sudo tee /etc/apt/sources.list.d/eaa3_ros-humble-franka-packages.list
